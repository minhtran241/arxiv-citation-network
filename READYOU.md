...
| Combinatorial structure of Kirillov-Reshetikhin crystals of type D_n(1),  B_n(1), A_{2n-1}(2) | 1               |
...
| Fermionic formulas for (1,p) logarithmic model characters in \Phi_{2,1}  quasiparticle realisation | 1               |
